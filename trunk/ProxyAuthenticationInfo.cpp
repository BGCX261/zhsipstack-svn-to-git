// ProxyAuthenticationInfo.cpp: implementation of the CProxyAuthenticationInfo class.
//
//////////////////////////////////////////////////////////////////////
...
CProxyAuthenticationInfo::CProxyAuthenticationInfo()
{
...
int CProxyAuthenticationInfo::Init()
{
	nextnonce = NULL;
	qop_options = NULL;
	rspauth = NULL;
...
void CProxyAuthenticationInfo::Free()
{
	mm_free(nextnonce);
	mm_free(qop_options);
	mm_free(rspauth);
...
int CProxyAuthenticationInfo::Parse( const char* hvalue )
{
	const char* space;
...
int CProxyAuthenticationInfo::ToStr(char** dest)
{
	size_t len;
	char* tmp;
...
int CProxyAuthenticationInfo::Clone( CProxyAuthenticationInfo** dest )
{
	CProxyAuthenticationInfo* wa;
	
	*dest = NULL;
	
	wa = new CProxyAuthenticationInfo();
...
char* CProxyAuthenticationInfo::GetNextNonce()
{
	return nextnonce;
}

void CProxyAuthenticationInfo::SetNextNonce( char* value )
{
	nextnonce = value;
}

char* CProxyAuthenticationInfo::GetCnonce()
{
	return cnonce;
}

void CProxyAuthenticationInfo::SetCnonce( char* value )
{
	cnonce = value;
}

char* CProxyAuthenticationInfo::GetQopOptions()
{
	return qop_options;	
}

void CProxyAuthenticationInfo::SetQopOptions( char* value )
{
	qop_options = value;
}

char* CProxyAuthenticationInfo::GetRspauth()
{
	return rspauth;
}

void CProxyAuthenticationInfo::SetRspauth( char* value )
{
	rspauth = value;
}

char* CProxyAuthenticationInfo::GetNonceCount()
{
	return nonce_count;	
}

void CProxyAuthenticationInfo::SetNonceCount( char* value )
{
	nonce_count = value;
}