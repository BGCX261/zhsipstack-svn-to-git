...
int CCallInfo::Parse( const char* hvalue )
{
...
int CCallInfo::Clone( CCallInfo** dest )
{
	int i;
	CCallInfo* ct;
...
char* CCallInfo::GetUrl()
{
	return element;
}

void CCallInfo::SetUrl( char* uri )
{
	element = uri;
}

int CCallInfo::ToStr( char** dest )
{
	char* buf;
	char* tmp;
	size_t len;
